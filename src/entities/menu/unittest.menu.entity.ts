import { InMemoryDBEntity, InMemoryDBEntityAsyncController } from "@nestjs-addons/in-memory-db";
import { Column, JoinTable, ManyToMany, ManyToOne, OneToOne, PrimaryGeneratedColumn } from "typeorm";
import { Category } from "../category/category.entity";
import { OptionGroup } from "../option/optionGroup.entity";
import { Store } from "../store/store.entity";
import { EnableTime } from "./enableTime.entity";

export class MenuEntity extends InMemoryDBEntity {
